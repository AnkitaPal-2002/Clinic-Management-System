...
INSERT INTO cms.Doctors (dUserName, doctorName, doctorSpecialist, doctorContacts, doctorEmail, doctorPassword, doctorFess, doctorExperience, doctorDescription, questionId, securityAnswer)
VALUES 
('anesthesiologist_01', 'Dr. John Doe', 'Anesthesiologists', 9876543210, 'john.anesthesiologist@example.com', '$2y$10$vOWFFOkE35RBTGoF9Qv9je.ASCiuUtxk4XUbJZRTwcpY911BG1Sa.', 500, 15, 'Expert in providing pain relief and monitoring patients during surgery.', 1, 'Dog');

INSERT INTO cms.Doctors (dUserName, doctorName, doctorSpecialist, doctorContacts, doctorEmail, doctorPassword, doctorFess, doctorExperience, doctorDescription, questionId, securityAnswer)
VALUES 
('cardiologist_01', 'Dr. Jane Smith', 'Cardiologists', 9876543220, 'jane.cardiologist@example.com', '$2y$10$vOWFFOkE35RBTGoF9Qv9je.ASCiuUtxk4XUbJZRTwcpY911BG1Sa.', 700, 20, 'Specialist in diagnosing and treating heart diseases.', 1, 'Dog');

INSERT INTO cms.Doctors (dUserName, doctorName, doctorSpecialist, doctorContacts, doctorEmail, doctorPassword, doctorFess, doctorExperience, doctorDescription, questionId, securityAnswer)
VALUES 
('colon_surgeon_01', 'Dr. Robert Brown', 'Colon and Rectal Surgeons', 9876543230, 'robert.colon@example.com', '$2y$10$vOWFFOkE35RBTGoF9Qv9je.ASCiuUtxk4XUbJZRTwcpY911BG1Sa.', 800, 10, 'Expert in treating disorders of the colon, rectum, and anus.', 1, 'Dog');

INSERT INTO cms.Doctors (dUserName, doctorName, doctorSpecialist, doctorContacts, doctorEmail, doctorPassword, doctorFess, doctorExperience, doctorDescription, questionId, securityAnswer)
VALUES 
('critical_care_01', 'Dr. Susan Lee', 'Critical Care Medicine Specialists', 9876543240, 'susan.criticalcare@example.com', '$2y$10$vOWFFOkE35RBTGoF9Qv9je.ASCiuUtxk4XUbJZRTwcpY911BG1Sa.', 900, 18, 'Provides advanced care for life-threatening conditions.', 1, 'Dog');

INSERT INTO cms.Doctors (dUserName, doctorName, doctorSpecialist, doctorContacts, doctorEmail, doctorPassword, doctorFess, doctorExperience, doctorDescription, questionId, securityAnswer)
VALUES 
('dermatologist_01', 'Dr. Emily White', 'Dermatologists', 9876543250, 'emily.dermatologist@example.com', '$2y$10$vOWFFOkE35RBTGoF9Qv9je.ASCiuUtxk4XUbJZRTwcpY911BG1Sa.', 600, 12, 'Diagnoses and treats skin conditions.', 1, 'Dog');
