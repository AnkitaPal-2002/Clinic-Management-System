...
function getAppointmentDetailsByDoctorUsername($username, $connection) {
    ...
    $sql = "SELECT p.firstName, p.lastName, a.appointmentReason, a.appointmentDate, a.appointmentTime, a.appointmentStatus FROM cms.Patients p JOIN cms.Appointments a ON p.pUserName = a.pUserName WHERE a.dUserName = '$username'";
